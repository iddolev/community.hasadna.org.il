...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_user', (
            ...
            ('email_privacy', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('english_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
    ...
    models = {
        ...
        u'users.user': {
            'Meta': {'ordering': "['nick']", 'object_name': 'User'},
